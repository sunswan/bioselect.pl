class Opalania {
    ...
    render() {
        const opalaniaStore = localStorageOpalania.getOpalania();
        let htmlCatalog = '';
              ...
              <div class="modal-dialog">
                  ...
                  <div class="produkty-page-heading"></div>
                    ...
                    <div class="container">
                      ...
                      <li class="current"><a href="/bioselect.pl/produkty/do_opalania/">DO OPALANIA</a>
                      </li>
                    </ul>
                      </div>
                    </div>
        ...
        ROOT_DO_OPALANIA.innerHTML = html;
    }
};

const opalaniaPage = new Opalania();