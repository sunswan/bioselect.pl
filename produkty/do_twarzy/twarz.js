class Twarz {
  ...
  render() {
      const twarzStore = localStorageTwarz.getTwarz();
      let htmlCatalog = '';
            ...
            <div class="modal-dialog">
                ...
                <div class="produkty-page-heading"></div>
                  ...
                  <div class="container">
                    ...
                    <li class="current"><a href="/bioselect.pl/produkty/do_twarzy/">DO TWARZY</a>
                    </li>
                  </ul>
                    </div>
                  </div>
      ...
      ROOT_DO_TWARZY.innerHTML = html;
  }
};

const twarzPage = new Twarz();