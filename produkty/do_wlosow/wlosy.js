class Wlosy {
    ...
    render() {
        const wlosyStore = localStorageWlosy.getWlosy();
        let htmlCatalog = '';
              ...
              <div class="modal-dialog">
                  ...
                  <div class="produkty-page-heading"></div>
                    ...
                    <div class="container">
                      ...
                      <li class="current"><a href="/bioselect.pl/produkty/do_wlosow/">DO WLOSOW</a>
                      </li>
                    </ul>
                      </div>
                    </div>
        ...
        ROOT_DO_WLOSOW.innerHTML = html;
    }
};

const wlosyPage = new Wlosy();