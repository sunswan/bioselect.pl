class Cialo {
    ...
    render() {
        const cialoStore = localStorageCialo.getCialo();
        let htmlCatalog = '';
              ...
              <div class="modal-dialog">
                  ...
                  <div class="produkty-page-heading"></div>
                    ...
                    <div class="container">
                      ...
                      <li class="current"><a href="/bioselect.pl/produkty/do_ciala/">DO CIALA</a>
                      </li>
                    </ul>
                      </div>
                    </div>
        ...
        ROOT_DO_CIALA.innerHTML = html;
    }
};

const cialoPage = new Cialo();