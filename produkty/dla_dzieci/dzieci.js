class Dzieci {
    ...
    render() {
        const dzieciStore = localStorageDzieci.getDzieci();
        let htmlCatalog = '';
              ...
              <div class="modal-dialog">
                  ...
                  <div class="produkty-page-heading"></div>
                    ...
                    <div class="container">
                      ...
                      <li class="current"><a href="/bioselect.pl/produkty/dla_dzieci/">DLA DZIECI</a>
                      </li>
                    </ul>
                      </div>
                    </div>
        ...
        ROOT_DLA_DZIECI.innerHTML = html;
    }
};

const dzieciPage = new Dzieci();