class Mezczyzn {
    ...
    render() {
        const mezczyznStore = localStorageMezczyzn.getMezczyzn();
        let htmlCatalog = '';
              ...
              <div class="modal-dialog">
                  ...
                  <div class="produkty-page-heading"></div>
                    ...
                    <div class="container">
                      ...
                      <li class="current"><a href="/bioselect.pl/produkty/dla_mezczyzn/">DLA MEZCZYZN</a>
                      </li>
                    </ul>
                      </div>
                    </div>
        ...
        ROOT_DLA_MEZCZYZN.innerHTML = html;
    }
};

const mezczyznPage = new Mezczyzn();